...
d=dir(fil);
name2 = 'AA_full_point9FR_reconstr_img-k=%3.1f-threshold_i=%3.1f.jpg'; 
j = 0;
...
%     title('Protocols')
    ...
    fine_model=meshio.read('15mm_height/9fr/newfinemodel20mm_9FR.vtu'); % change path
...
%     title('Fine model circular 20mm diameter', 'Fontsize', 20)
    ...
    coarse_model =meshio.read('15mm_height/9fr/newcoarsemodel20mm_9FR.vtu'); % change
...
fid= fopen('AA-FULL-POINT_RECONSTRUCTION-9FR.html','w');
